...
///////////////- NEED TO CHANGE -/////////////
let INFURA_URL:Credentials = 'https://goerli.infura.io/v3/<INFURA ID>' // paste your infura url
...
// https://goerli.api.0x.org/swap/v1/quote?sellToken=${sellToken}&buyToken=${buyToken}&sellAmount=${sellAmount}&takerAddress=${account}`
...
getQuote(USDC,'ETH',10000,USDCdecimals,takerAddress)
// allowance()
